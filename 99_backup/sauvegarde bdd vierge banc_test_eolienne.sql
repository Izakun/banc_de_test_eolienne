...
--
-- Dumping data for table `eoliennes`
--
...
--
ALTER TABLE `eoliennes`
MODIFY `ID_eolienne` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=8;
--
-- AUTO_INCREMENT for table `releves`
--
ALTER TABLE `releves`
MODIFY `ID_releves` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=8715;
--
-- AUTO_INCREMENT for table `scenarios`
--
ALTER TABLE `scenarios`
MODIFY `ID_scenarios` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=16;
--
-- AUTO_INCREMENT for table `sequences`
--
ALTER TABLE `sequences`
MODIFY `ID_sequences` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=52;
--
