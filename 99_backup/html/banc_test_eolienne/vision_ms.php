<head>
    <meta http-equiv="refresh" content="15;url=vision_ms.php" /> <!-- permet de recharger la page toute les 15 secondes ( temporaire ) -->
</head>
...
<div class="row">
        <div class="col-lg-1"></div>
            ...
            <center>
                ...
                <script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script><!-- source du script permettant la construction du graphique -->
                ...
                <script type="text/javascript">
                    google.load;//charge les paramètres google
                      ...
                      function drawChart() {
                        ...
                        ['heure', 'Force du vent (en m/s)', 'Puissance fournie (en Watts)'],

                          <?php
                            releves_chart_ms() // fonction qui permet de recupérer et d'afficher les 100 dernieres entrées de la bases de données
