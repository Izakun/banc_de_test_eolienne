...
public:
    ...
    void setupUi(QWidget *createScenario)
    {
        ...
        tab_db = new QTableWidget(groupBox);
        tab_db->setObjectName(QStringLiteral("tab_db"));
        tab_db->setGeometry(QRect(10, 110, 361, 151));
        tab_db->setColumnCount(0);
        QWidget::setTabOrder(txt_scenario, btn_create);
        QWidget::setTabOrder(btn_create, combo_scenario);
        QWidget::setTabOrder(combo_scenario, txt_phase);
        QWidget::setTabOrder(txt_phase, nb_power);
        QWidget::setTabOrder(nb_power, nb_time);
        QWidget::setTabOrder(nb_time, btn_add);
        QWidget::setTabOrder(btn_add, tab_db);
